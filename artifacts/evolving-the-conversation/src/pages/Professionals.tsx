    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-24 bg-white text-center border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <CTAButton href="https://koalendar.com/e/professional-english-consultation-or-consulta-corporativa-de-ingles-profesional" className="shadow-2xl">{t('professionals.closing.btn')}</CTAButton>
        </div>
      </section>
    </div>
  );
